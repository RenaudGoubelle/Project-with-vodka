...
class Component extends App{
  ...
  <div class="nav-wrapper #212121 grey darken-4">
   ...
   <div class="row">
        ...
        <div class="col s6 m6">
          <div class="card card-big #3e2723 brown darken-4"">
            <div class="card-image #3e2723 brown darken-4">
              <img src="http://armedforcesmuseum.com/wp-content/uploads/2012/04/Tank-M4-Sherman.jpg" class="resizeimg">
              <span class="card-title" style="color:#ff0000;">M4 Sherman</span>
            </div>
            ...
            <div class="card-action #d50000 #3e2723 brown darken-4 white-text">
              <a href="https://google.com" id="update" class="white-text">UPDATE</a>
              <a href="https://google.com" id="delete" class="white-text">DELETE</a>
              <a href="https://google.com" id="more" class="white-text">MORE</a>
            </div>
          </div>
        </div>
        ...
        <div class="col s6 m6">
          <div class="card card-big #3e2723 brown darken-4">
            <div class="card-image #3e2723 brown darken-4">
              <img src="http://www.warlordgames.com/wp-content/uploads/2016/11/ST03.jpg"  class="resizeimg">
              <span class="card-title" style="color:#ff0000;">M3 Stuart</span>
            </div>
            <div class="card-content #3e2723 brown darken-4 white-text">
              <p>American light tank development in the USA was confounded with tank development itself.</p>
            </div>
            <div class="card-action ##3e2723 brown darken-4 white-text">
              <a href="https://google.com" id="update" class="white-text">UPDATE</a>
              <a href="https://google.com" id="delete" class="white-text">DELETE</a>
              <a href="https://google.com" id="more" class="white-text">MORE</a>
            </div>
	...
	<div class="row">
        <div class="col s6 m6 ">
          <div class="card card-big #3e2723 brown darken-4">
            <div class="card-image #3e2723 brown darken-4">
              <img src="http://wotlabs.net/articles/wp-content/uploads/2014/03/kv-2-heavy-tank-05.png"  class="resizeimg">
	  ...
	  <div class="col s6 m6 ">
          <div class="card card-big #3e2723 brown darken-4">
            <div class="card-image #3e2723 brown darken-4 ">
              <img src="http://www.achtungpanzer.com/images/hunpz4.jpg"  class="resizeimg">
              <span class="card-title" style="color:#ff0000;"> Panzerkampfwagen IV Ausf F(F1).</span>
            </div>
            <div class="card-content #3e2723 brown darken-4 white-text">
              <p >Panzerkampfwagen IV was the main German tank of World War II, in action from September 1st of 1939 to May 9th of 1945.</p>
            </div>
            <div class="card-action #3e2723 brown darken-4 white-text">
              <a href="https://google.com" id="update" class="white-text">UPDATE</a>
              <a href="https://google.com" id="delete" class="white-text">DELETE</a>
